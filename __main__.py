...
def start(update, context):
    ...
    buttons.buildbutton("Telegram", "https://t.me/Aashath")
...
'''
        ...
        sendMarkup('Your are Not Authorized user Join 👉 @c2ptech and use me...., ', context.bot, update, reply_markup)
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        try:
            text = "<b>Bot Successfuly Restarted!</b>"
    ...
    LOGGER.info("Bot Successfuly Started!")
